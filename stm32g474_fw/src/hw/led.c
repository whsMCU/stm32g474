...
{
  {GPIOC, GPIO_PIN_6,  GPIO_PIN_SET, GPIO_PIN_RESET},   // 0. DEBUG
  {GPIOC, GPIO_PIN_10, GPIO_PIN_SET, GPIO_PIN_RESET},   // 1. RX
  {GPIOC, GPIO_PIN_11, GPIO_PIN_SET, GPIO_PIN_RESET},   // 2. TX
  {GPIOB, GPIO_PIN_5,  GPIO_PIN_SET, GPIO_PIN_RESET},   // 3. CAN
  {GPIOB, GPIO_PIN_1,  GPIO_PIN_SET, GPIO_PIN_RESET},   // 4. RS485
};
